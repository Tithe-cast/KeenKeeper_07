...
const TYPE_CONFIG = {
  call:  { icon: Phone,         color: 'text-blue-600',   bg: 'bg-blue-50',   border: 'border-blue-100',   label: 'Call'  },
  text:  { icon: MessageSquare, color: 'text-purple-600', bg: 'bg-purple-50', border: 'border-purple-100', label: 'Text'  },
  video: { icon: Video,         color: 'text-green-600',  bg: 'bg-green-50',  border: 'border-green-100',  label: 'Video' },
}
...
<div className="relative mb-6 inline-block" ref={dropdownRef}>
  <button
    ...
    className="inline-flex items-center justify-between gap-2 px-4 py-2.5 bg-white border border-[#E9E9E9] rounded-lg text-sm text-[#101727] shadow-sm"
  >
  ...
  {dropdownOpen && (
    <div className="absolute z-10 mt-2 min-w-[180px] bg-white border border-[#E9E9E9] rounded-lg shadow-md overflow-hidden">
      {FILTERS.map((f) => (
        <button
          key={f}
          onClick={() => {
